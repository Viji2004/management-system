...
public class updateemp implements ActionListener{
	...
	JTextField f2,f4,f5,f7,f9,f6,f8;
...
public updateemp(String empid){
	...
	try {
	  ...
	  while(rs.next()) {
		 ...
		 f2.setText(rs.getString("fname"));
		 f3.setText(rs.getString("dob"));
		 f4.setText(rs.getString("salary"));
		 f5.setText(rs.getString("address"));
		 f6.setText(rs.getString("phone"));
		 f7.setText(rs.getString("email"));
		 f8.setText(rs.getString("education"));
		 f9.setText(rs.getString("designation"));
		 f0.setText(rs.getString("aadhar"));
		 h12.setText(rs.getString("empid"));
	  }
	}
	catch(Exception e) {
		e.printStackTrace();
	...
	//adding employee
	click1=new JButton("Update Details");
